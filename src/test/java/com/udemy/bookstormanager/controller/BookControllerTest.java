...
import static com.udemy.bookstormanager.utils.BookUtils.asJsonString;
import static com.udemy.bookstormanager.utils.BookUtils.createFakeBookDTO;
...
public class BookControllerTest {
    ...
    void testWhenPOSTisCalledThenABookShouldBeCreated() throws Exception {
        ...
        MessageResponseDTO expectedMessageResponse = MessageResponseDTO.builder()
                .message("Book salvo com sucesso" + bookDTO.getName() + 
        				" o livro tem o numero de paginas de " + bookDTO.getPages() + 
        				" com id " + bookDTO.getId())
                .build();
